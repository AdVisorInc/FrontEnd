      ...
      >
        ...
        >
          <FormControl
            ...
            disabled
          >
            <InputLabel htmlFor="company-disabled-input">
              Company
              <Typography
                component="span"
                fontWeight={400}
        ...
        <Grid xs={12}>
          <FormControl
            ...
            required
          >
            <InputLabel htmlFor="validation-input">Validation</InputLabel>
            <OutlinedInput
              id="validation-input"
              type="email"
              label="Validation"
        ...
        >
          ...
          >
            ...
            />
            <FormHelperText>Composed input with adornments</FormHelperText>
          </FormControl>
        </Grid>
        <Grid
          xs={12}
        ...
        >
          <FormControl
            ...
            fullWidth
          >
            <InputLabel htmlFor="members-input">Members</InputLabel>
            <OutlinedInput
              id="members-input"
              type="text"
              label="Members"
